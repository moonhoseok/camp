...
<div class="w3-row">
	<div class="w3-col s2 w3-center">
		...
		<div class="w3-col s2 w3-center">
		<p><form:input path="pass" class="w3-input w3-border" placeholder="비밀번호"/>
			<font color="red"><form:errors path="pass"/></font>
		</p>
	</div>
	<div class="w3-col s7 w3-center">
		<p><form:input path="content" class="w3-input w3-border" placeholder="내용"/>
			<font color="red"><form:errors path="content"/></font>
		</p>
	</div>
	<div class="w3-col s1 w3-center">
		<p><button type="submit" class="w3-bnt w3-border">[댓글등록]</button></p>
	</div>
</div>
</form:form>
