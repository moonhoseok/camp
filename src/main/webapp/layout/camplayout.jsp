...
<div class="w3-top">
   <div class="w3-bar w3-white w3-card" id="myNavbar">
      <a href="#home" class="w3-bar-item w3-button w3-hover-light-grey" style="padding:20px 16px"><b>GUDEE</b> camping</a>
      <!-- Right-sided navbar links -->
      <div class="w3-right w3-hide-small">
         <a href="#about" class="w3-bar-item w3-button w3-hover-light-grey" style="padding:20px 16px"><i class="fa fa-home" style="color:plum"></i> 홈</a>
            ...
            <a href="#pricing" class="w3-bar-item w3-button w3-hover-light-grey" style="padding:20px 16px"><i class="fa fa-cloud" style="color:lightblue"></i> 날씨</a>
             <a href="${path}/board/list?boardid=1" class="w3-bar-item w3-button w3-hover-light-grey"
             style="margin-right:50px; padding:20px 16px"><i class="fa fa-heart" style="color:pink"></i> 커뮤니티</a>
             <c:if test="${empty sessionScope.loginUser }">
            <a href="#contact" class="w3-bar-item w3-button w3-hover-light-grey" style="padding:20px 16px">
...
<nav class="w3-sidebar w3-bar-block w3-lime w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a href="#about" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-light-grey">홈</a>
  <a href="#team" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-light-grey">캠핑장 찾기</a>
  <a href="${path}/board/list?boardid=1" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-light-grey">커뮤니티</a>
  <a href="#pricing" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-light-grey">날씨</a>
  <a href="#contact" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-light-grey">회원가입</a>
</nav>
